...
def seed_items_images():
    ...
    item_image2 = ItemImage(
        itemId=2, imageUrl='https://images.lululemon.com/is/image/lululemon/LM5956S_033928_1?wid=1280&op_usm=0.5,2,10,0&fmt=webp&qlt=80,1&fit=constrain,0&op_sharpen=0&resMode=sharp2&iccEmbed=0&printRes=72')
